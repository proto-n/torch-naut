...
if __name__ == "__main__":
    ...
    net = JointPositionExtractor().to(device)
    ...
    for k in range(2000):
        ...
        with torch.no_grad():
            ...
            for ixs in get_batch_ixs(X_val_sv, 1000):
                ...
                x, w = net(X)
                loss = crps.crps_loss_mv_weighted(x, w, y.unsqueeze(1)).mean()
    ...
    torch.save(best_model, "results/wcrps_handpose.pt")
    # net.load_state_dict(torch.load("results/wcrps_handpose.pt"))
